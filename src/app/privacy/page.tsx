...
export const metadata: Metadata = {
  title: "Privacy Policy — ClinicalSift",
  description: "Privacy policy for ClinicalSift — what data is and isn't collected.",
};
  ...
  return (
    <div className="container max-w-2xl mx-auto px-4 py-12 space-y-8 text-sm leading-relaxed">
      ...
      <div className="p-4 rounded-lg border border-green-200 bg-green-50 dark:border-green-900 dark:bg-green-900/20 text-green-900 dark:text-green-200 font-medium">
        Short version: <strong>ClinicalSift does not collect, store, or transmit your personal
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Nothing. ClinicalSift has no database, no user accounts, and no server that stores
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          When you run a search, ClinicalSift makes two external requests on your behalf:
        </p>
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ClinicalSift does not set any cookies. Your theme preference (light/dark) and trial
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ClinicalSift is intended for use by adults, typically caregivers or patients seeking
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          You don&apos;t have to take our word for it. ClinicalSift is fully open source. You can
