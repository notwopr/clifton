...
export const metadata: Metadata = {
  title: "Terms & Disclaimer — ClinicalSift",
  description: "Terms of use and disclaimer for ClinicalSift.",
};
  ...
  return (
    <div className="container max-w-2xl mx-auto px-4 py-12 space-y-8 text-sm leading-relaxed">
      ...
      <div className="p-4 rounded-lg border border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-900/20 text-amber-900 dark:text-amber-200 font-medium">
        ClinicalSift is a research and discovery tool. It is <strong>not a medical service</strong> and
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-base">What ClinicalSift does</h2>
        <p className="text-muted-foreground">
          ClinicalSift fetches publicly available clinical trial data from ClinicalTrials.gov and
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Nothing on ClinicalSift — including trial rankings, eligibility estimates, scoring, or
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ...
          Library of Medicine. ClinicalSift does not independently verify this data. Trial
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ClinicalSift is an independent project. It is not affiliated with, endorsed by, or
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ClinicalSift is provided "as is" without warranty of any kind, express or implied.
          To the maximum extent permitted by applicable law, the creator of ClinicalSift shall
        ...
        <p className="text-muted-foreground">
          You use ClinicalSift at your own risk. You are solely responsible for any decisions
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ClinicalSift is open source software released under the{" "}
          <a
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          These terms may be updated at any time. Continued use of ClinicalSift after changes
